...
description: "Early findings from dbt-agent-skills: how skills make a coding agent more systematic across model creation, unit tests, and natural language querying in a dbt project."
---
...
![Creating an intermediate model to enrich orders at line item level](/img/1_model_creation_intermediate.gif)
...
![Creating a mart table from intermediate models](/img/2_model_creation_mart.gif)
...
![Adding a dbt unit test on the intermediate model](/img/3_test_intermediate.gif)
...
![Answering a natural language question with dbt](/img/4_natural_language_query.gif)
