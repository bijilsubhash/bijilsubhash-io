...
![Creating an intermediate model to enrich orders at line item level](/img/model-creation-intermediate.gif)
...
![Creating a mart table from intermediate models](/img/model-creation-mart.gif)
...
![Adding a dbt unit test on the intermediate model](/img/unit-test-intermediate.gif)
...
![Answering a natural language question with dbt](/img/natural-language-query.gif)
