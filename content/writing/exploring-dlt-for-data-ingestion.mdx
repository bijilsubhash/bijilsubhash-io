---
title: Exploring the Capabilities of Data Load Tool (dlt)
date: "2024-08-04"
tags: [data ingestion, open source]
description: "A hands-on look at dlt: what it is, why declarative Python ingestion matters, and a worked Adzuna-to-BigQuery pipeline deployed on GitHub Actions."
---
...
![2024 Machine Learning, AI and Data landscape](/img/mad.png)
...
```json
{
  ...
  "description": "Employment Type: Permanent Full Time, working 38 hours per week ...",
  "title": "Data Engineer (Health Mgr Lvl 3) - Perm FT",
