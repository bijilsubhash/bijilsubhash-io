...
description: "Practical lessons from building dlt pipelines: the REST client, incremental loading, destinations, transformers, and tuning for memory and compute."
---

Couple of months ago, I
[shared](/writing/exploring-dlt-for-data-ingestion) my
