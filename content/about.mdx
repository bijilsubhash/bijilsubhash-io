I'm a data and AI engineer from Sydney, Australia. I embed with client teams to design, build, and productionise data platforms end to end, from discovery and architecture through to the systems that run in production.
...
I came to data the long way around: a PhD in chemical engineering at UNSW, then data science, and finally the engineering work I enjoy most. I'm certified across Databricks (Professional Data Engineer, Spark Developer), GCP (Professional Data Engineer), dbt (Cloud Architect), Azure, and HashiCorp. The full timeline is on my [CV](/cv).
